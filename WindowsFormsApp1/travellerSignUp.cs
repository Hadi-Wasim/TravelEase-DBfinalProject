...
namespace WindowsFormsApp1
{
    public partial class travellerSignUp : Form
    {
        ...
        string connectionString = @"Data Source=HADI-HP\SQLEXPRESS;Initial Catalog=travelease;Integrated Security=True;";
            ...
            string query = @"
            DECLARE @nextId INT;
            SELECT @nextId = ISNULL(MAX(travellerID), 0) + 1 FROM traveller;

            INSERT INTO traveller (travellerid, Name, email, password)
        ...
        private void travellerSignUp_Load(object sender, EventArgs e)
        {
